<cfcomponent name="links">
	...
	<cffunction name="get" returntype="query" output="false">
		...
		<cfscript>
			...
			tempLinks = application.fileSystem.readxml('#request.appPath#/storage/xml/links/links.cfm');
	...
	<cffunction name="saveFile" output="false" returntype="void">
		...
		<cfscript>
			application.fileSystem.writexml('#request.appPath#/#request.xmlstoragepath#/links/','links',links);
		</cfscript>

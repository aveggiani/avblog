			...
			<cfoutput>
				<div class="catList">
					...
					<cfloop query="qryCategories">
						...
						<cfif howmany gt 0>
							<!---
							<span class="catListElement"><a href="#request.blogmapping#index.cfm?mode=showcategory&amp;name=#qryCategories.name#">#listrest(qryCategories.name,'_')#</a> (#howmany#)<br /></span>
							--->

<cfcomponent>
	...
	<cffunction name="get" output="false" returntype="struct">
		...
		<cfscript>
			qryVerify = application.fileSystem.getDirectoryxml('#request.BlogPath#/#request.xmlstoragepath#/comments','datelastmodified','#arguments.id#_*');
		</cfscript>
		<cfloop query="qryVerify" startrow="1" endrow="1">
			<cfscript>
				xmlComment = application.fileSystem.readXml('#request.BlogPath#/#request.xmlstoragepath#/comments/#qryVerify.name#');
	...
	<cffunction name="getPostComments" output="false" returntype="array">
		...
		<cfscript>
			qryVerify = application.fileSystem.getDirectoryxml('#request.BlogPath#/#request.xmlstoragepath#/comments','datelastmodified','*_#arguments.id#');
		</cfscript>
		<cfif qryVerify.recordcount gt 0>
			<cfloop query="qryVerify">
				<cfscript>
					if (qryVerify.name is not '' and fileexists('#request.BlogPath#/#request.xmlstoragepath#/comments/#qryVerify.name#'))
						{
							xmlComment = application.fileSystem.readXml('#request.BlogPath#/#request.xmlstoragepath#/comments/#qryVerify.name#');
							xmlComment = xmlParse(xmlComment);
							strGet.id				= xmlComment.comment.guid.xmltext;
	...
	<cffunction name="getAllCommentsCount" output="false" returntype="numeric">
		<cfscript>
			qryCommentsDirectory = application.fileSystem.getDirectoryxml('#request.BlogPath#/#request.xmlstoragepath#/comments','datelastmodified desc');
		</cfscript>
	...
	<cffunction name="getRecent" output="false" returntype="query">
		...
		<cfloop query="qryCommentsDirectory" startrow="#rstart#" endrow="#rend#">
			<cfscript>
				xmlComment = application.fileSystem.readXml('#request.BlogPath#/#request.xmlstoragepath#/comments/#qryCommentsDirectory.name#');
				xmlComment = xmlparse(xmlComment);
	...
	<cffunction name="save" output="false" returntype="void">
		...
		<cfscript>
			application.fileSystem.writexml('#request.BlogPath#/#request.xmlstoragepath#/comments','#commentid#_#arguments.id#','#item#');
		</cfscript>
	...
	<cffunction name="delete" output="false" returntype="void">
		...
		<cfscript>
			qryVerify = application.fileSystem.getDirectoryxml('#request.BlogPath#/#request.xmlstoragepath#/comments','','#arguments.id#_*');
		</cfscript>
		<cfif qryVerify.recordcount gt 0>
			<cfloop query="qryVerify">
				<cfscript>
	...
	<cffunction name="publish" output="false" returntype="void">
		...
		<cfscript>
			var strGet		= structnew();
			qryVerify = application.fileSystem.getDirectoryxml('#request.BlogPath#/#request.xmlstoragepath#/comments','name','#arguments.id#_*');
		</cfscript>

<cfcomponent>
	...
	<cffunction name="get" output="false" returntype="query">
		...
		<cfscript>
			var qryCategory = application.fileSystem.getDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/','name');
		</cfscript>
	...
	<cffunction name="getCategoryByName" output="false" returntype="string">
		...
		<cfscript>
			var qryCategory = application.fileSystem.getDirectoryName('#request.BlogPath#/#request.xmlstoragepath#/categories','*_#arguments.name#');
		</cfscript>
	...
	<cffunction name="getBlogs" output="false" returntype="query">
		...
		<cfscript>
			...
			var qryDirectory		= '';
			qryDirectory = application.fileSystem.getDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#arguments.category#','name','*.txt');
		</cfscript>

		<cfloop query="qryDirectory">
			<cfscript>
				qryBlogsDirectory = application.fileSystem.getDirectoryxml('#request.BlogPath#/#request.xmlstoragepath#/entries/','name','*_#listgetat(qryDirectory.name,1,'_')#');
			</cfscript>
	...
	<cffunction name="getBlogsCount" output="false" returntype="string">
		...
		<cfscript>
			var qryDirectory = application.fileSystem.getDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#arguments.category#','name','*.txt');
		</cfscript>
	...
	<cffunction name="getMine" output="false" returntype="string">
		...
		<cfloop query="qryCategory">
			...
			<cfscript>
				qryBlogs = application.fileSystem.getDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#qryCategory.name#/','name','#arguments.blogid#*');
			</cfscript>
	...
	<cffunction name="saveBlogCategories" output="false" returntype="void">
		...
		<cfloop index="i" from="1" to="#listlen(arguments.listCategory)#">
			...
			<cfelse>
				<cfscript>
					qryCategorySave = application.fileSystem.getDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/','name','*_#listgetat(listCategory,i)#');
					categorySave = qryCategorySave.name;
				</cfscript>
			</cfif>
			<cfscript>
				if (categorySave is not '')
					application.fileSystem.writeFile('#request.BlogPath#/#request.xmlstoragepath#/categories/#categorySave#','#arguments.id#_#arguments.title_menu#.txt',text);
				categorySave = '';
			</cfscript>
		</cfloop>
	...
	<cffunction name="save" output="false" returntype="void">
		...
		<cfscript>
			if (not isdefined('arguments.name'))
				{
					qryCategory = application.fileSystem.getDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/');
				...
				name = arguments.name;			
			application.fileSystem.createDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#arguments.percorso#','#name#_#arguments.category#');
		</cfscript>
	...
	<cffunction name="delete" output="false" returntype="void">
		...
		<cfscript>
			application.fileSystem.deleteDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#arguments.percorso#/#arguments.category#','yes');
		</cfscript>
	...
	<cffunction name="modify" output="false" returntype="void">
		...
		<cfscript>
			qryCategory = application.fileSystem.getDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/','','#arguments.prefix#_*');
			if (not request.bluedragon and not request.railo)
				{
					application.fileSystem.renameDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#qryCategory.name#','#arguments.prefix#_#arguments.category#');
					application.fileSystem.renameDirectory('#request.BlogPath#/permalinks/categories/#listlast(qryCategory.name,'_')#','#arguments.category#');
				}
			else
				{
					application.fileSystem.renameDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#qryCategory.name#','#request.BlogPath#/#request.xmlstoragepath#/categories/#arguments.prefix#_#arguments.category#');
					application.fileSystem.renameDirectory('#request.BlogPath#/permalinks/categories/#listlast(qryCategory.name,'_')#','#request.BlogPath#/permalinks/categories/#arguments.category#');
				}
		</cfscript>
	...
	<cffunction name="saveOrder" output="false" returntype="void">
		...
		<cfloop index="i" from="1" to="#arraylen(arrayCategoryOrder)#">
			<cfscript>
				qryCategory = application.fileSystem.getDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/','name','*_#listgetat(arrayCategoryOrder[i],2,'_')#');
			</cfscript>
			<cfloop query="qryCategory">
				<cfif qryCategory.type is 'dir'>
					<cfif request.cfmx>
						<cfscript>
							application.fileSystem.renameDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#qryCategory.name#','@#arrayCategoryOrder[i]#');
						</cfscript>
					<cfelse>
						<cfscript>
							application.fileSystem.renameDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#qryCategory.name#','#request.BlogPath#/#request.xmlstoragepath#/categories/@#arrayCategoryOrder[i]#');
						</cfscript>
					</cfif>
				</cfif>
			</cfloop>
		...
		<cfscript>
			qryCategory = application.fileSystem.getDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/','name','*_*');
		</cfscript>
		<cfloop query="qryCategory">
			<cfif qryCategory.type is 'dir'>
				<cfif request.cfmx>
					<cfscript>
						application.fileSystem.renameDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#qryCategory.name#','#right(qryCategory.name,decrementvalue(len(qryCategory.name)))#');
					</cfscript>
				<cfelse>
					<cfscript>
						application.fileSystem.renameDirectory('#request.BlogPath#/#request.xmlstoragepath#/categories/#qryCategory.name#','#request.BlogPath#/#request.xmlstoragepath#/categories/#right(qryCategory.name,decrementvalue(len(qryCategory.name)))#');
					</cfscript>
				</cfif>
			</cfif>
		</cfloop>

<cfcomponent>
	...
	<cfscript>
		...
		returnvalue = "#request.blogmapping#permalinks/#left(arguments.date,4)#/#mid(arguments.date,5,2)#/#right(arguments.date,2)#/#rereplace(replace(arguments.menuitem,' ','-','ALL'),'[^A-Za-z0-9_-]*','','ALL')#";
	</cfscript>

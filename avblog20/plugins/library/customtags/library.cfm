		...
		<cfif GetAuthUser() is not "">
			<cfif isuserinrole('admin')>
				<cfoutput>
					...
					<br />
					[ <a href="#request.blogmapping#index.cfm?mode=plugin&amp;pluginmode=edit&amp;plugin=library">#application.pluginslanguage.library.language.addlibrary.xmltext#</a> ]
					<br />
					[ <a href="#request.blogmapping#index.cfm?mode=plugin&amp;pluginmode=view&amp;plugin=library">#application.pluginslanguage.library.language.modifylibrary.xmltext#</a> ]
				</cfoutput>
			</cfif>
		</cfif>
	</cfcase>
				...
				<vb:pod>
					<div class="functionMenu">
						...
						<cfoutput query="application.Library" group="category">
							&nbsp; <a href="#request.blogmapping#index.cfm?mode=plugin&amp;plugin=library&amp;pluginmode=view&amp;category=#application.library.category#">#application.library.category#</a>
							<br />
							<cfoutput>
								&nbsp; &nbsp; <a href="#request.blogmapping#index.cfm?mode=plugin&amp;plugin=library&amp;pluginmode=view&amp;id=#listgetat(application.library.id,1,'.')#">#application.library.name#</a>
								<br />
							</cfoutput>
						</cfoutput>

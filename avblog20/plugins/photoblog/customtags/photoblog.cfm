			...
			<vb:cache action="#request.caching#" name="side_photoblog" timeout="#request.cachetimeout#">		
				<vb:pod>
					<div class="functionMenu">
						<span class="catListTitle"><a href="<cfoutput>#request.blogmapping#index.cfm</cfoutput>?mode=plugin&amp;pluginmode=view&amp;plugin=photoblog"><cfoutput>#application.pluginslanguage.photoblog.language.name.xmltext#</cfoutput></a></span>
						<br />
						<cfoutput query="application.photoblog" group="category">
							&nbsp; <a href="#request.blogmapping#index.cfm?mode=plugin&amp;plugin=photoblog&amp;pluginmode=view&amp;category=#application.photoblog.category#">#application.photoblog.category#</a>
							<br />
							<cfoutput>
								&nbsp; &nbsp; <a href="#request.blogmapping#index.cfm?mode=plugin&amp;plugin=photoblog&amp;pluginmode=view&amp;id=#listgetat(application.photoblog.id,1,'.')#">#application.photoblog.name#</a>
								<br />
							</cfoutput>
						</cfoutput>
			...
			<cfoutput query="myphotoblog">
				...
				<div class="blogBody">
					...
					<div class="blogAuthor" align="right">
						<cfif isuserinrole('admin')>
							[<a href="#request.blogmapping#index.cfm?mode=plugin&amp;plugin=photoblog&amp;pluginmode=delete&amp;id=#mygallery#">#application.language.language.delete.xmltext#</a>] 
							<cfif useAjax()>
								[<a href="#request.blogmapping#index.cfm?mode=plugin&amp;plugin=photoblog&amp;pluginmode=edit&amp;id=#mygallery#">#application.language.language.edit.xmltext#</a>]
							</cfif>
						</cfif>
					</div>
				</div>		
		...
		<cfif isuserinrole('admin')>
			...
			<vb:content>
				...
				<div class="editorBody">
					...
					<br />
					<vb:wtab id="lhtabs" style="width: 100%; height: 600px;" selectedTab="tab1" closeButton="tab">

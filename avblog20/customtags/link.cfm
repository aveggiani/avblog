						...
						<cfloop query="application.links">
							<cfoutput>
								<tr id="idrecord_#replace(application.links.id,'-','_','ALL')#">
									...
									<td>&nbsp;[<vb:wa href="#request.blogmapping#index.cfm?mode=links&updateLink=#application.links.id#">#application.language.language.edit.xmltext#</vb:wa>]
									[<vb:wa href="#request.blogmapping#index.cfm?mode=links&deleteLink=#application.links.id#">#application.language.language.delete.xmltext#</vb:wa>] #application.links.name#</td>
								</tr>
							</cfoutput>
						</cfloop>
					</table>

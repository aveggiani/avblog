		...
		<cfif isuserinrole('admin')>
			<vb:content>
				<div class="editorBody">
					...
					<div align="center">
						<form id="theForm" name="theForm" action="<cfoutput>#request.blogmapping##listlast(cgi.SCRIPT_NAME,'/')#</cfoutput>?mode=ping" method="post" onsubmit="return submitHandler(this);"/> 

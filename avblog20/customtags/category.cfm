									...
									<cfif listlen(qryCategories.name,'_') gt 1>
										<cfoutput>
											<tr id="idrecord_#qryCategories.currentrow#">
												...
												<td>&nbsp;[<vb:wa href="#request.blogmapping#index.cfm?mode=category&amp;modifycategory=#qryCategories.name#">#application.language.language.edit.xmltext#</vb:wa>]
												[<vb:wa href="#request.blogmapping#index.cfm?mode=category&deletecategory=#qryCategories.name#">#application.language.language.delete.xmltext#</vb:wa>] #listrest(qryCategories.name,'_')#</td>
											</tr>
										</cfoutput>
									</cfif>
								</cfloop>

							...
							<div class="trackbackNotPublished">
								<div class="trackbackBody">
									...
									<div class="trackbackDate">#right(date,2)# #lsdateformat(createdate(2000,mid(date,5,2),1),'mmmm')# #left(date,4)# #trackbacks.time#
										<cfif isuserinrole('admin')>
											[<vb:wa href="#request.blogmapping#index.cfm?mode=deletetrackback&idtrackback=#urlencodedformat(trackbacks.id)#&id=#urlEncodedFormat(trackbacks.blogid)#">#application.language.language.delete.xmltext#</vb:wa>]
											[<vb:wa href="#request.blogmapping#index.cfm?mode=viewtrackback&idtrackback=#urlencodedformat(trackbacks.id)#&id=#urlEncodedFormat(trackbacks.blogid)#&publish=#trackbacks.published#"><cfif trackbacks.published>#application.language.language.notpublished.xmltext#<cfelse>#application.language.language.published.xmltext#</cfif></vb:wa>]
										</cfif>
									</div>

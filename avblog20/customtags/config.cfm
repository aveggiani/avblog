							...
							<cfformgroup type="hbox" width="100%">
								...
								<cfformgroup type="vbox" width="360" height="100%">
									...
									<cfformgroup type="vbox" style="border: 1px solid black">
										...
										<cfinput type="text" name="feedmailkey" enabled="{feedemail.selected}" value="#application.configuration.config.options.feed.email.subjectkey.xmltext#" label="#application.language.language.configfeedemailsubject.xmltext#">

<cfcomponent>
	...
	<cffunction name="deletesubscriptions" access="public" output="false" returntype="void">
		...
		<cflock name="#arguments.blogid#_subscribe" type="exclusive" timeout="20">
			<cfif fileexists('#request.BlogPath#/#request.xmlstoragepath#/subscriptions/#arguments.blogid#.cfm')>
				<cffile action="read" file="#request.BlogPath#/#request.xmlstoragepath#/subscriptions/#arguments.blogid#.cfm" variable="fileSubscription" charset="#request.charset#">
			<cfelse>
				<cfscript>
			...
			<cffile action="write" file="#request.BlogPath#/#request.xmlstoragepath#/subscriptions/#arguments.blogid#.cfm" output="#fileSubscription#" charset="#request.charset#">
		</cflock>
	...
	<cffunction name="getBlogsubscriptions" access="public" output="false" returntype="query">
		...
		<cfif fileexists('#request.BlogPath#/#request.xmlstoragepath#/subscriptions/blog.cfm')>
			<cflock name="blog_check" type="exclusive" timeout="20">
				<cffile action="read" file="#request.BlogPath#/#request.xmlstoragepath#/subscriptions/blog.cfm" variable="fileSubscription" charset="#request.charset#">
			</cflock>
			<cfscript>
	...
	<cffunction name="delete" access="public" output="false" returntype="query">
		...
		<cflock name="#arguments.blogid#_check" type="exclusive" timeout="20">
			<cffile action="delete" file="#request.BlogPath#/#request.xmlstoragepath#/subscriptions/#arguments.blogid#.cfm">
		</cflock>

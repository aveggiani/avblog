<cfcomponent>
	...
	<cffunction name="save" access="public" output="false" returntype="void">
		...
		<cfscript>
			application.fileSystem.writexml('#request.BlogPath#/#request.xmlstoragepath#/logs','#arguments.date#_#replace(arguments.time,':','_','ALL')#_#arguments.id#_#arguments.type#','#log#');
		</cfscript>
	...
	<cffunction name="get" access="public" output="false" returntype="query">
		...
		<cfscript>
			...
			qryLog = application.fileSystem.getDirectoryxml('#request.BlogPath#/#request.xmlstoragepath#/logs','name desc','#filter#');
		</cfscript>
		
		<cfloop query="qryLog">
			<cfscript>
				strFile 		= application.fileSystem.readXml('#request.BlogPath#/#request.xmlstoragepath#/logs/#qryLog.name#');
	...
	<cffunction name="clear" access="public" output="false" returntype="void">
		<cfargument name="type" 		type="string" 	required="yes">
			...
			<cfscript>
				qryLog = application.fileSystem.getDirectoryxml('#request.BlogPath#/#request.xmlstoragepath#/logs','','*_#arguments.type#');
			</cfscript>
			<cfloop query="qryLog">
				<cfscript>
					application.fileSystem.deleteFile('#request.BlogPath#/#request.xmlstoragePath#/logs/#qryLog.name#');
				</cfscript>
			</cfloop>

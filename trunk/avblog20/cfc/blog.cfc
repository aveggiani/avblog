		...
		<cfsavecontent variable="rssfeed">
			...
			<rss version="2.0">
				<channel>
					...
					<image>
						<title>#application.configuration.config.headers.title.xmltext#</title>
						<url>http://#cgi.server_name#/#request.blogmapping#skins/#application.configuration.config.layout.theme.xmltext#/images/logo.gif</url>
						<link>#application.configuration.config.owner.blogurl.xmltext#</link>
						<description>#application.configuration.config.headers.description.xmltext#</description>
					</image>
								...
								<cfloop index="j" from="1" to="#arraylen(arrayshow)#">
									...
									<cfif (isdefined('arguments.category') and listfind(mycategories,arguments.category)) or not isdefined('arguments.category')>
										...
										<item>
											...
											<comments><![CDATA[http://#cgi.server_name##request.blogmapping#index.cfm?mode=viewcomment&id=#arrayshow[j].id#]]></comments>
											...
											<cfloop query="enclosures">
												<enclosure type="#enclosures.type#" url="#request.blogmapping#user/enclosures/#enclosures.name#" length="#enclosures.length#"></enclosure>
											</cfloop>
										</item>
		...
		<cfsavecontent variable="atomfeed">
			<cfoutput>
				<feed xmlns="http://www.w3.org/2005/Atom">
					<id>tag:#cgi.server_name#,#year(now())#:#request.blogmapping#</id>
					<title type="text">#application.configuration.config.headers.title.xmltext#</title>
					<link rel="self" href="http://#cgi.server_name##request.blogmapping#feed/atom.cfm"/>
					<author>
										...
										<entry>
											...
											<cfloop query="enclosures">
												<link rel="enclosure" 
													  ...
													  href="#request.blogmapping#user/enclosures/#enclosures.name#"

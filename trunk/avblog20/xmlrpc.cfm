							...
							if (not structisempty(post))
								{
									...
									myResponse[1]["link"] ="$string" & "http://#cgi.server_name##request.blogmapping#index.cfm?mode=viewEntry&id=#post.id#";
											...
											if (howmany gt 0)
												{
													...
													myResponse[1][j]["link"] ="$stringhttp://#cgi.server_name##request.blogmapping#index.cfm?mode=viewEntry&id=#arrayShow[k].id#";

						...
						<cfoutput>
							<vb:pod>
								<div class="pluginflickrSide">
									...
									<div class="pluginDeliciousSideTitle"><a href="#request.blogmapping#index.cfm?mode=plugin&amp;plugin=flickr&amp;pluginmode=showall">#application.pluginslanguage.flickr.language.showall.xmltext#</a></div>
								</div>
							</vb:pod>
						</cfoutput>
					</cfif>

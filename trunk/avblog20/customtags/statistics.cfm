			...
			<div class="editorForm">
				...
				<cfif qry.recordcount gt 0>
					...
					<div class="blogText">
										...
										<cfloop query="qryGroup">
											<cfif listlen(qryGroup.type,'_') is 3>
												...
												<tr>
													...
													<td>
														<a href="#request.blogmapping#index.cfm?mode=statistics&type=pageview&detail=#qryGroup.type#">#page#<cfif mode is not 'default'>?mode=#mode#</cfif></a>
													</td>
												</tr>
											</cfif>
										</cfloop>
											...
											<tr>
												...
												<td>
													<cfif structkeyexists(structPost,'id')>
														<a href="#request.blogmapping#index.cfm?mode=viewentry&amp;id=#listgetat(qryGroup.type,1,'_')#">
													</cfif>
							...
							<cfcase value="commentadd">
								<table>
									<cfloop query="qry">
										...
										<tr>
											<td colspan="2" style="border-bottom: 1px solid black;">
												<a href="#request.blogmapping#index.cfm?mode=viewcomment&amp;id=#listgetat(qry.type,1,'_')#">#title#</a>
											</td>
										</tr>
									</cfloop>
								</table>
										...
										<cfloop query="qry" startrow="#start#" endrow="#end#">
											...
											<!--- <cftry> --->
												...
												<tr>
													...
													<td>
														<cfif structkeyexists(structPost,'id')>
															<a href="#request.blogmapping#index.cfm?mode=viewentry&amp;id=#listgetat(qry.type,1,'_')#">
														</cfif>
																#structPost.title#
														<cfif structkeyexists(structPost,'id')>
															</a>
						...
						<div align="center"><br />[<a href="#request.blogmapping#index.cfm?mode=statistics&amp;type=#url.type#&clear=1">#application.language.language.delete.xmltext# #url.type# log</a>]</div>
					</div>
				</cfif>
				<div class="statisticsMenu">
					|
					<cfif application.configuration.config.log.login.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=login">login</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.logout.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=logout">logout</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.sessionstart.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=sessionstart">sessionstart</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.sessionend.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=sessionend">sessionend</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.applicationstart.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=applicationstart">applicationstart</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.applicationend.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=applicationend">applicationend</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.pageview.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=pageview">pageview</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.download.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=download">download</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.postview.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=postview">postview</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.postadd.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=postadd">postadd</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.postmodify.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=postmodify">postmodify</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.commentadd.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=commentadd">commentadd</vb:wa>
						|
					</cfif>
					<cfif application.configuration.config.log.trackbackadd.xmltext>
						<vb:wa href="#request.blogmapping#index.cfm?mode=statistics&amp;type=trackback">trackback</vb:wa>
						|
					</cfif>
				</div>
			</div>

...
function appendPingRow(id) {
	_TABLE_EDITOR_.appendPingRow(id);
}

function appendSpamRow(id) {
	_TABLE_EDITOR_.appendSpamRow(id);
}
 ...
 *	by the id 'rowId' 
 */
TableEditor.prototype.appendPingRow = function(rowId) {
    ...
    var tableData = this.getPingTableData(newId);
 ...
 * @return array with td items
 */
TableEditor.prototype.getPingTableData = function (newId) {
    var td1 = document.createElement('td');
    var input1 = document.createElement('input');
    input1.setAttribute("name", "item_" + newId);
    input1.setAttribute("type", "text");
 ...
 *	by the id 'rowId' 
 */
TableEditor.prototype.appendSpamRow = function(rowId) {
    ...
    var tableData = this.getSpamTableData(newId);
 ...
 * @return array with td items
 */
TableEditor.prototype.getSpamTableData = function (newId) {
    var td1 = document.createElement('td');
    var input1 = document.createElement('input');
    input1.setAttribute("name", "item_" + newId);
    input1.setAttribute("type", "text");

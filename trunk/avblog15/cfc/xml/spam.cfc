<cfcomponent>
	...
	<cfscript>
		if (not fileexists('#request.appPath#/#request.xmlstoragepath#/spamlist/spamlist.cfm'))
			{
					application.fileSystem.writeXML('#request.appPath#/#request.xmlstoragepath#/spamlist','spamlist','<antispamlist></antispamlist>');
			}
	</cfscript>
